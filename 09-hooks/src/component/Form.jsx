...
const Form = () => {
    ...
    const handleSubmit = (e) => {
        ...
        console.log(
            `Le nom est ${name}, le pseudo est ${username}, le mot de passe est goulagwe, et le genre est ${gender === 'male' ? 'Homme' : 'Femme'
        }`
...
// mettre  >>> "jsx-a11y/label-has-associated-control": "off", dans .eslintrc quand on fait un formulaire 
...
const [joke, setJoke] = useState ({});
  ...
  return (
      <div>
          ...
          <h2 className='py-1 text-center text-xl bg-black hover:bg-transparent'>{joke.answer}</h2>
          <button type='button' className='mt-8 px-4 py-2 text-white bg-indigo-600' onClick={reloadJoke}>Une nouvelle blague ?</button>
      </div>
  );
};

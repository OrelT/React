...
const ListSimple =() => {
    ...
    useEffect(() =>{
        ...
        search.toLowerCase() === 'maxime' ? setIsMot(true) : setIsMot(false);
    ...
    <form className="w-1/2 p-8 m-8 max-auto bg-gray-100 shadow" onSubmit={handleSubmit}>
        <div className="w-1/2 mb-4">
         ...
         <p className="pt-2 text-sm text-red-500">{isMot && 'Maxime est un homme en or.'}</p>
